...
#	
#	for i <- 0 to both_strings.length
#		add <- True
#		for j <- 0 to new_string.length
...
if __name__ == "__main__":
	strings = input("Enter two strings separated by spaces: ").split(' ')
	string1 = strings[0]
	string2 = strings[1]
	print("function a output: " + functionA(string1, string2))
	print("function b output: " + functionB(string1, string2))
	print("function c output: " + functionC(string1, string2))